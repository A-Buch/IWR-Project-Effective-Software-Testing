...
def main():
    ...
    attrici_out = "/p/projects/ou/rd3/dmcci/basd_era5-land_to_efas-meteo/attrici_output_anna/"
    fact_dir = Path("/p/projects/ou/rd3/dmcci/basd_era5-land_to_efas-meteo/basd_for_attrici/")
    ...
    if not os.path.isfile(cfact_dir / f"rechunked_ERA5_{variable_hour}_ERA5_1950_2020_t_{tile}_basd_redim_f_cfact_rechunked_valid.nc4"):
        cfact_dir = Path(f"{attrici_out}/final_cfacts/{tile}/attrici_03_era5_t{tile}_{variable_hour}_rechunked/cfact") / variable
        print("Searching in", cfact_dir)
