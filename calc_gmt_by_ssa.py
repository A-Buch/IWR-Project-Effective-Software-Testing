...
dataset = "ERA5"  # "GSWP3-W5E5"
testarea = "testarea_97"
output_base = Path("/p/tmp/annabu/attrici_interpolation/meteo_data/")
output_dir = output_base / dataset / testarea

input_file = output_dir / Path("tas12_" + dataset.lower() + "_1950_2020_00023_ba_ncpdq_merged_97.nc4")
mean_file = str(input_file).replace("_1950_2020_00023_ba_ncpdq_merged_97.nc4", "_gmt.nc4")
ssa_file = str(mean_file).replace("tas12_", "").replace("_gmt", "_ssa_gmt")
print("ssa_file: ", ssa_file)
